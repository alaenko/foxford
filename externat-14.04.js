...
$( document ).ready(function() {
  ...
  const showSum = function() {
    switch(sumParams.class) {
      case '1':
      case '2':
        prices.basePrice = 15750
        prices.baseOnlinePrice = 2150
        prices.iomOnlinePrice = 0
        break
      case '3':
      case '4':
        prices.basePrice = 24750
        prices.baseOnlinePrice = 2750
        prices.iomOnlinePrice = 0
        break
      case '5':
      case '6':
  ...
  $('#calc-class').change(function() {
    ...
    switch($(this).val()) {
      ...
      case '2':
        ...
        $('.price-form-info-text').text("- Онлайн-занятия и записи занятий,\n- Интерактивные задания и методические материалы на портале,\n- Обратная связь с классным руководителем,\n- Поддержка психолога.");
        break
    case '3':
    case '4':
        $('.price-form-info-heading').text('3-4 классы');
        $('.price-form-info-text').text("- Онлайн-занятия и записи занятий,\n- Методические вебинары для родителей,\n- Интерактивные задания и методические материалы на портале,\n- Обратная связь с классным руководителем,\n- Поддержка психолога.");
    }
  })
