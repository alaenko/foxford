...
$( document ).ready(function() {
  ...
  function showSum() {
    if (pay === '1') {
      ...
      $('#price-subtext').text('Стоимость оплаты в рассрочку за месяц')//Оплатить за весь учебный год выгоднее');
    } 
  }
  ...
  $('.pay-btn').click(function() {
   ...
   if (pay === '1') {
    $('.price-form-info-heading').text('Оплата за год');
     ...
     $('.price-form-info-text').text('Платежи вносятся 20 числа каждого месяца. Оплату можно разбить на два платежа.')//8 платежей. Вносятся 28 числа каждого месяца.');
    }
   showSum()
  });
